...
class Configs(BaseConfigs):
    ...
    def init(self):
        ...
        self.sub_archead = ArcMarginHead(
            ...
            load_backbone = '/home/yiqduan/Data/bci/EEG_MI_DARTS/Mudus_BCI/logs/subjects_normal/BCI_IV_EEGNet_batchsize256_lr0.05_gamma0.5_step20_maxepoch100_exp1/max_acc.pth', 
...
def main():
    ...
    experiment.create(name='none_constraint_subject_gaussion_unet_att_loss_ep100_withorga_arc_normalized', writers={'screen', 'comet'})
