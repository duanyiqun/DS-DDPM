...
class sub_gaussion(Module):
    ...
    def __init__(self, image_channels: int = 3, n_channels: int = 64,
        ...
        * `n_blocks` is the number of `UpDownBlocks` at each resolution
        ...
        # Project image into feature map
        self.mu_projection = nn.Conv2d(image_channels, n_channels, kernel_size=(3, 3), padding=(1, 1))
        self.theta_projection = nn.Conv2d(image_channels, n_channels, kernel_size=(3, 3), padding=(1, 1))
        ...
        self.final_mu = nn.Conv2d(n_channels, image_channels, kernel_size=(3, 3), padding=(1, 1))
        self.final_theta = nn.Conv2d(n_channels, image_channels, kernel_size=(3, 3), padding=(1, 1))
